...
Joshua S. Schiffman$^{\dagger \ast}$ \qquad Peter L. Ralph$^{\ddagger \ast}$ \\ \vspace{0.5cm}
$^{\dagger}${\footnotesize {Current affiliations: New York Genome Center, NY, NY 10013 \& Weill Cornell Medicine, NY, NY 10065  \\
$^{\ddagger}$Departments of Mathematics and Biology \& The Institute for Ecology and Evolution, University of Oregon, Eugene, OR 97403 \\ 
$^{\ast}$Work conducted at: Molecular and Computational Biology, University of Southern California, LA, CA 90089} } \\ \vspace{0.5cm}
