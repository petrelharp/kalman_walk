...
\section*{Introduction}
  \jss{I'm not sure we still need this first paragraph -- I don't feel like it says that much?}
...
Examples can be found across nearly all levels of biological organization from the level of the genetic code itself \citep{crick, woesse}
all the way up to the convergent evolution of adaptive traits. Between these levels, structural plasticity can be found in the \emph{neutral networks}
  of nucleic acid sequences that map to an RNA secondary structure \citep{gruner, andmore}\revpoint{1}{5} and amino acid sequences that fold similarly \citep{babajide},
...
and neural circuits \citep{trojanowski}, and in developmental systems \citep{true2001developmental}. 
...
Structural plasticity has been argued to be necessary for natural selection \citep{edleman2001degeneracy}, 
as it may function as a mechanism for biological robustness and evolvability \citep{robustness}, or manifest as 
\emph{canalization} \citep{canalization}. Degeneracy of the genetic code, and of genetic networks, 
for instance, can make sequences more fault-tolerant to mutations and open up pathways to adaptation (cite). 
Non-invertibility can also enable the evolution of neutral and nearly neutral molecular changes \citep{kimura},
and perhaps even contribute to the formation of new species \citep{gavrilets}. 
...
which we develop in more detail in a companion paper \citep{schiffman2020genetic}.
...
even under universal pleiotropy \citep{universal_pleiotropy,omnigenic},
XXX
