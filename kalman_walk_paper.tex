...
is due to $n$ fixed differences with additive effect size $\epsilon/(2n)$ each,
then the standard deviation of $A_{ij}$ among the $F_1$ offspring is equal to that
within each parent population, while among the $F_2$ offspring it is $\epsilon / \sqrt{8 n}$.
