...
A great deal of analytical work on the question of speciation
has been done under the assumption of a monomorphic population
...
we provide often heuristic arguments,
...
but will have higher variance \citep{barton2001role,rosas2010cryptic,chevin2014niche}.
...
Substantial analytical work has made similar observations
using Fisher's geometric model, 
including Haldane's rule and the $F_2$ ``speciation clock'' 
\citep{barton2001role,fraisse2016genetics,simon2017coadapted}.
These calculations are similar in spirit, 
but differ from our own in that they primarily assume a monomorphic population.
