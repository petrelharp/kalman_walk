...
This has been analyzed for traits under stabilizing selection determined additively by alleles at many loci 
...
\citet{phillips1996maintenance} showed that population structure
can allow long-term stable coexistence of incompatible genotypes encoding identical phenotypes.
...
We use similar tools in the second half of this paper,
differing in that we have a submanifold of optima rather than a single point.
Using simulations, \citet{tulchinsky2014hybrid}
...
as a result of segregation load \citep[similarly to][]{fraisse2016genetics}.
...
The same holds for the ``pathway model'' of \citet{lindtke2015genetic},
...
and curvature of the optimal set,
...
We would like to thank Sergey Nuzhdin, Stevan Arnold, Michael Turelli, Patrick Phillips, Erik Lundgren, and Hossein Asgharian for valuable discussion. We would also like to thank Nick Barton, Sarah Signor and Todd Parsons for helpful comments on the manuscript.
%
