...
phenogenetic drift \citep{weiss2000phenogenetic} or developmental system drift \citep{true2001developmental}.
...
system drift is be a significant -- and often rapid -- driver of speciation.
...
that if only one hybrid sex is inviable or sterile it is likely to be the heterogametic sex.
...
This model therefore may provide a neutral ``null'' model of gene network evolution \citep{koonin2016splendor}.
\plr{revisit}
