...
The fundamental nonidentifiability of chemical reaction networks is sometimes referred to as the ``dogma of chemical kinetics'' \citep{craciun2008identifiability}. 
...
\begin{example}[All phenotypically equivalent gene network wirings] \label{ex:all_osc}
