...
{\centering
{\Large \bf Rapid speciation despite conservation of phenotype} \\
...
proceeds at a rate inversely proportional the amount of intrapopulation genetic variation
...
\plr{I removed the $0.1 N_e$ because that's only in the "metapopulation" case,
which is where you've probably already got subpopulations acting like species already.}
...
even in the absence of any sort of adaptative, selective, or environmental change. 
...
\plr{we don't need to summarize the results of the paper in the introduction.  the abstract, and maybe the discussion, but not the introduction.}
...
For instance, \citet{tulchinsky2014hybrid} looked for hybrid incompatibility
...
\plr{missing any important references here?}
...
We first describe the class of models we study, such as gene regulatory networks. 
The behavior (i.e., the temporal dynamics) of such a system is determined by a collection of $n$ coregulating moleculues -- such as transcription factors, as well as external or environmental inputs.
