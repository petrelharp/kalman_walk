...
\citep[the ``segregation variance''][]{slatkin1994segregation}.
...
which can also predict Haldane's rule and the $F_2$ ``speciation clock'' 
...
between populations, i.e., neglecting within-species polymorphism.
