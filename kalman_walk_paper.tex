...
\end{align*}
With $\sigma/\gamma = c_\sigma \sqrt{T/N_e}$
and $\mu/\gamma = c_\mu T/N_e$,
this is (check!!)
$$
...
If $\sigma_N \approx \sigma_S \approx \gamma$ and variance in $F_2$s increases linearly with distance betw parents,
then fitness starts to drop at $T/4N_e$.
