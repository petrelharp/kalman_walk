...
(say something about here we interpret the big math expression in words)
...
argue sometimes $\sigma_N \approx \sigma_S \approx \gamma$, especially if $N_e$ is big
(``large species'')

and that sometimes $\sigma_N \approx \sigma_S \ll \gamma$, but only if $N_e$ is small
(``isolated population'')

and that sometimes maaybe $\sigma_N \gg \sigma_S \approx \gamma$, if $N_e$ is big and there's a lot of recombination load
(``species complex'')
