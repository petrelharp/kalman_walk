...
We will quanitfy how far a system's phenotype is from optimal
...
simply because this is the the standard deviation of the mean of a random sample \citep{lande1981models}.
...
\plr{that citation is Lynch \& Hill 1986, "phenotypic evolution by neutral mutation"}
...
\plr{JOSH: insert a citation or two to something non-human?}
...
is often found in practice in moderately complex models of biological systems. 
\plr{Josh, add citation to sensitivity analysis}
...
\paragraph{Peter to add quant gen discussion} about non-normality.
