...
A large, adapted population will move around in $\allS$ under environmental and selective stasis. In the minimal dimension neutral evolution proceeds as a stochastic coordinate transformation on the elements in $\Sys_{\min}$. Even if there is conservation of phenotype through evolutionary time, the molecular mechanism underpinning the phenotype is not constrained and likely will not be conserved.
