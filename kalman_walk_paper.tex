...
\begin{align*}
  \mathbb{E} \left[ d(F_1)] \right] &= \int_{0}^{2\pi} \int_{0}^{2\pi} \left\lVert \frac{1}{8 \pi^{2}} \left( \left( \cos(\theta_1), \sin(\theta_1) \right) + \left( \cos(\theta_2), \sin(\theta_2) \right) \right) \right\rVert d\theta_1 d\theta_2 \\
