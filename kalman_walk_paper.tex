...
Experiments in which population bottlenecks were induced to study the effect of drift on speciation found no reproductive isolation in the majority tested pairs. 
In contrast, experiment has provided stronger support for incompatibilities evolving as a byproduct of divergent selection\citep{fry2009laboratory, white2020past}, 
...
Fluctuating selection \citep{bell2010fluctuating} could further accelerate speciation via system drift. 
Under our model, populations evolving towards different optimal phenotypes will always produce less fit hybrids,
as the hybrid phenotypes will be displaced from both parental optimums, suggesting that selection fluctuation -- if not synchronized between populations -- will diminish hybrid fitnesses.
