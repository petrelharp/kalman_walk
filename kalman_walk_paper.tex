...
Studying natural flycatcher populations, \citet{wang2017bayesian} found that 7.2--8.5\% of transcripts showed allele-specific expression -- indicitive of standing genetic \emph{cis}-regulatory variation. Similarly, in wild baboons, \citet{tung2015genetic} observed allele-specific expression in 23.4\% of genes studied. 
