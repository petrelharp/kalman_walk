...
%\end{align}
 ...
 %    \end{align*}
  ...
  \section*{Phenotype-equivalent gene networks}
...
-- minimal, informally meaning that the system's phenotype is achieved with the fewest possible genes 
...
\subsection*{The rate of speciation under neutrality in allopatric populations}
...
If the strength of selection is only a few multiples $\xi_1$ of the standing phenotypic diversity within a population $\sigma_S$, such that $\beta = \xi_1 \sigma_S$, and recombination load constrains the standing kryptotype diversity $\sigma_N$ to be only a few multiples $\xi_2$ of $\sigma_S$, then $F_2$ fitness will be,
  \begin{align}
    \exp\left(-\left( \xi \sqrt{\frac{T}{N_e}} \right)^{2} \right)
  \end{align}
  where $\xi := 2\xi_2/\xi_1$.
  This suggests that if a population contains as much phenotypic diversity as allowed by selection and if $\sigma_N$ is on the order of $\sigma_S$, reproductively isolated populations can speciate rapidly -- on timescales shorter than $N_{e}$ generations.
