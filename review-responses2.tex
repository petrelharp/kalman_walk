...
\reply{ \jss{I think this might be a question you will be better at answering? FYI, we already cite Rosas 2010 and Fraisse 2016 on page 2.}
}
...
\reply{\jss{To do. I think our options are to either add an appendix where we show that this model does or does not generate ``dominance relations'', add a sentence explaining why it does or does not, or just say it is consistent with Muller's ``balance argument'' (Barton 2001) and punt on whether or not it is or is not consistent with the dominance theory. What do you think?

There also might be a nice solution when discussing the Martin 2014 paper about how systems biology and quantitative genetics models approximate one another (as R1 mentions above). Some concepts might be lost in translation.
}
}
...
\reply{ Fixed \revref. \jss{Although I like the original phrasing better...}
}
