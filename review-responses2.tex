...
and would like to thank you and the reviewers for your suggestions, as they have helped us improve our manuscript's clairty.
We also would like to thank you and the reviewers for the enthusiasm and positive feedback; we are happy that our manuscript was seen as interesting and relevant.

Both reviewers made comments about the section on Haldane's rule, of which we have revised to address their concerns. 
We also made an effort to provide more context for our manuscript by citing the relevant literature, as requested by Reviewer 1. 
...
We hope that by making these revisions you will find this manuscript fit for publication. 


%We are writing to submit a revision of our manuscript, ``{System drift and speciation}'' (ID 18-0316), for your review. 
...
%In addition to the revised text, we are submitting as supplementary files,
%a detailed response to the reviews and a color-coded diff to make it easy to see what has been removed.
...
%\url{https://www.biorxiv.org/content/10.1101/231209v2}). Furthermore, this paper has been downloaded more than 2,326 times (\url{https://rxivist.org/papers/24911}),
%making it the 155$^{\text{th}}$ most downloaded evolutionary biology paper available on the \emph{bioRxiv}, as of this writing.
%   
...
is more consistent with the ordering of the rest of text.
}
