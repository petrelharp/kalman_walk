...
suggestions, I add a few more below.
\end{point}
...
\begin{point}{Additional references:}
...
François Blanquart and Thomas Bataillon
...
GENETICS Early online April 6, 2016
\end{point}
...
\begin{point}{(mechanistic models)}
  ...
  spaces exist in the (quite different) context of RNA folding (papers by
Hofacker, Fontana, etal)
\end{point}
...
\begin{point}{Introduction:}
    ``It is not a new observations that there is often more than one way to do the same thing, and that this may lead to speciation'' - Isn't this what people would call a neutral Dobzhansky-Muller incompatibility?
\end{point}
...
landscape (conceptual figure 4), right? If two populations in alloparty drift
