...
\begin{point}{end of p6:} 
    ``we assume ... $((A + A' )/2, (B + B' )/2, (C + C' )/2)$'' . It is claimed \revreffull{2}{1}
...
\reply{
    We have improved Figure~\ref{fig:conceptual_fig} and made the accompanying discussion
    more concrete to hopefully better demonstrate the point.
}
