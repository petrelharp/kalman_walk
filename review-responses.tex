...
We are pleased to submit a revision of our manuscript, ``{System drift and speciation},'' for your review. 
We apologize for the delayed resubmission but hope that you will find the
...
suggestions as detailed in our pont-by-point response below. 
...
and thus will follow the recommendation of both the Editor and Associate Editor, to break the manuscript into
two papers. One paper will focus on quantitative genetics, and the other -- 
the focus of this present revision -- will focus on system theory. 
A revised manuscript focusing on quantitative genetics will be submitted at a later date.

We hope that by focusing this paper system theory, we have clarified our results, which include a mathematical description of phenotypically equivalent network space 
...
and often not reproductively compatible, leaving many oportunities for independelty evolving populations to become reproductively incompatible.
The linear system framework applied in this manuscript explicitly describes possible moleuclar pathways and naturally predicts Haldane's rule.

We would like to note that the previous version of this paper as a preprint has since recieved 10 citations as well as attracted
...
making it the 156$^{\text{th}}$ most downloaded evolutionary biology paper available on the bioRxiv, as of this writing.
...
\reply{
  ...
  We've reworked the introduction, adding these (and many other) additional references. \revref
}
...
\reply{
    ...
    \plr{JOSH: how's this?}
    \jss{Sounds great! We could also add:}
...
\reply{
    \plr{should put somethign about this in the discussion?}
    \jss{I think we should definitely address it in the discussion -- and in the main text of the ridge paper.
    Do you think we can say something about the ridge for the minimal oscillator being constant across parameter space?}
    We have added a paragraph to the discussion to address these points. \revref
}
...
\reply{
    We aim to do that in the subsequent paper.
}
...
\reply{
    \plr{... and also this?}
    We have added a paragraph to the discussion to address this point. \revref
}
