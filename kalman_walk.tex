...
\usepackage{graphicx}
\usepackage{fullpage}
\usepackage[backref, hidelinks, colorlinks=true, citecolor=blue!60!black!100]{hyperref}
\usepackage{tikz}
