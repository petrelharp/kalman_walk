...
\begin{enumerate}
    ...
    \item \emph{(josh)} Add biology to introduction. (keep an eye out for concrete numbers we can use!)
    ...
    \item \emph{(josh,peter)} Prove or find citation for uniqueness of minimal system up to basis change.
